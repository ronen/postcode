...
1. Human Unicode-output inspection: the human reviewed `view-after.txt` and
   requested further changes, then reviewed samples two and three. The
   [fourth review response](../reviews/2026-09-13-unicode-fourth-response.md)
   records the latest corrections and `view-review-4.txt` and exceptional inspection samples. Explicit human
