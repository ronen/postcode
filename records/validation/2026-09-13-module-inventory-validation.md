...
1. Human Unicode-output inspection: the human reviewed `view-after.txt` and
   requested further changes, then reviewed sample two. The
   [third review response](../reviews/2026-09-13-unicode-third-response.md)
   records the latest corrections and `view-review-3.txt` sample. Explicit human
