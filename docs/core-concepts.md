...
This document states PostCode's governing cross-cutting architectural concepts. It says what governs now; accepted [decision records](decisions/) preserve why the concepts were adopted or changed. It conforms to the adopted [product design](../foundation/product-design.md), which governs product direction rather than implementation architecture.
