...
Notes may link to canonical documents and to other notes. Drafts may link to notes while planning is in progress, but promotion must remove or replace those links and carry any required context into the promoted material. Canonical and governing documents should normally remain independent of notes. Mutable repository guides may link here for navigation, and an exceptional optional link from another mutable canonical document is permissible only when that document remains complete without the note and the link is removed or updated when the note is deleted.
