...
These guidelines do not establish product meaning, governing architectural concepts, consequential architectural choices, or mechanical practices of the current codebase. Those belong respectively in the adopted foundation, [`docs/core-concepts.md`](../docs/core-concepts.md), accepted [decision records](../docs/decisions/), and [`docs/implementation-conventions.md`](../docs/implementation-conventions.md).
